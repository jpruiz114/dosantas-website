...
<html>
	<head>
		...
		<title>Dosantas - Everywear Clothing - Error 401</title>
		
		<link rel="image_src" href="/assets/dosantas-everywear-clothing-logo.png" />
		
		<link href="http://fonts.googleapis.com/css?family=Josefin+Slab" rel="stylesheet" type="text/css">
		
		<link rel="stylesheet" type="text/css" media="screen" href="/error-pages/css/error-401.css" />
		...
		<div id="main-container">
			<div id="central-container">
				...
				<div class="title-container">
					<span class="huge-title">Error 401</span>
					
					<br>
					<br>
					
					<span class="small-text">Algo salió mal pero te podemos recomendar un par de cosas</span>
				</div>
				
				<div class="spacer"></div>
				
				<div style="margin-top: 10px;">
					<a class="simple-button" href="/" rel="follow" title="Regresar">
						<img alt="Regresar" src="/assets/btn-regresar.png" width="186" height="34" />
					</a>
				</div>
				
				<div class="banner-container">
					<span class="small-text"><strong>Colección Mar Adentro</strong></span>
				...
				<div class="banner-container">
					<span class="small-text"><strong>Colección Fractales</strong></span>
